...
serve(async (req) => {
  ...
  try {
    ...
    const { bookingId, title, totalDays, arrivalDate, departureDate, adults, children, existingDays } = await req.json();
    ...
    const prompt = `You are a professional travel planner AI. Generate or enhance itinerary day details for a trip.
        ...
        tools: [
          {
            ...
            function: {
              ...
              description: "Generate structured itinerary day data",
              parameters: {
                type: "object",
                properties: {
                  days: {
                    ...
                    items: {
                      ...
                      required: ["day_number", "title", "short_description", "city"],
