...
const cities = [
  ...
  { name: "Aswan", nameAr: "أسوان", country: "EG", region: "Middle East" },
  { name: "Dahab", nameAr: "دهب", country: "EG", region: "Middle East" },
  { name: "Marsa Alam", nameAr: "مرسى علم", country: "EG", region: "Middle East" },
  { name: "Siwa Oasis", nameAr: "واحة سيوة", country: "EG", region: "Middle East" },
  { name: "El Gouna", nameAr: "الجونة", country: "EG", region: "Middle East" },
  { name: "Ain Sokhna", nameAr: "العين السخنة", country: "EG", region: "Middle East" },
  { name: "Marsa Matrouh", nameAr: "مرسى مطروح", country: "EG", region: "Middle East" },
  { name: "Fayoum", nameAr: "الفيوم", country: "EG", region: "Middle East" },
  { name: "Taba", nameAr: "طابا", country: "EG", region: "Middle East" },
  { name: "Nuweiba", nameAr: "نويبع", country: "EG", region: "Middle East" },
  { name: "Ras Sudr", nameAr: "رأس سدر", country: "EG", region: "Middle East" },
  { name: "Port Said", nameAr: "بورسعيد", country: "EG", region: "Middle East" },
  { name: "Ismailia", nameAr: "الإسماعيلية", country: "EG", region: "Middle East" },
  { name: "Giza", nameAr: "الجيزة", country: "EG", region: "Middle East" },
  { name: "Abu Simbel", nameAr: "أبو سمبل", country: "EG", region: "Middle East" },
  { name: "Edfu", nameAr: "إدفو", country: "EG", region: "Middle East" },
  { name: "Kom Ombo", nameAr: "كوم أمبو", country: "EG", region: "Middle East" },
  { name: "El Alamein", nameAr: "العلمين", country: "EG", region: "Middle East" },
  { name: "Sahel", nameAr: "الساحل الشمالي", country: "EG", region: "Middle East" },
